...
// loading skeleton. The Hop-specific part is the pause button, which this game
// needs because every tap on the board is a hop and pausing therefore can't
// share the tap.

(function () {
  var LANDING_URL = "https://www.oddsrabbit.com/games/hop/";
  ...
  var IDLE_TEXT = IS_TOUCH ? "TAP TO HOP" : "PRESS SPACE TO HOP";
  ...
  function buildShareTitle(result) {
    return result.isNewBest
      ? "Hop — new high score: " + result.score
      : "Hop — score: " + result.score;
  }
